...
class Disciplina(db.Model):
    ...
    materiais = db.relationship("Material", back_populates="disciplina")

    atividades = db.relationship("Atividade", back_populates="disciplina")
...
class Material(db.Model):
    ...
    disciplina = db.relationship("Disciplina", back_populates="materiais")

    professor = db.relationship("Usuario", back_populates="materiais")
...
class Atividade(db.Model):
    ...
    disciplina = db.relationship("Disciplina", back_populates="atividades")

    professor = db.relationship("Usuario", back_populates="atividades")
...
class Usuario(db.Model):
    ...
    materiais = db.relationship("Material", back_populates="professor")

    atividades = db.relationship("Atividade", back_populates="professor")
...
class Matricula(db.Model):
    ...
    data_matricula = db.Column(db.DateTime, nullable=False, default=datetime.now)
